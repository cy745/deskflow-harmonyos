...
export const onClipboardData: (callback: (event: ValueChangeEvent) => void) => void;
export const pushClipboard: (text: string) => string;
export const setClipboardSync: (enable: boolean) => string;
